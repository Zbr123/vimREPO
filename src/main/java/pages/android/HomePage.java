...
public class HomePage {
    ...
    public HomePage(Page page) {
     ...
     public WebElement getProfileIcon() {
         return AndroidDriverSetup.getAndroidDriver().findElement(MobileBy.xpath(profileIconXpath));
     }
     public WebElement getCareInsightTab(){
        return AndroidDriverSetup.getAndroidDriver().findElement(MobileBy.xpath(careInsightTabXpath));
     }
     public WebElement getInfoButton(){
         return AndroidDriverSetup.getAndroidDriver().findElement(MobileBy.xpath(infoButtonHomeXpath));
     }
}
