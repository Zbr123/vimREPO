...
//
//    protected PageMainWeb getPageMainWeb() {
//        return pageMainWeb;
//    }
//
...
//
//    protected PageAdminWeb getPageAdminWeb() {
//        return getPageAdminWeb;
//    }
//
...
//
//    protected PageForgotPasswordWeb getPageForgotPassword() {
//        return getPageForgotPassword;
//    }
//
//    private final PageSeniorDashboardWeb getPageSeniorDashboard = new PageSeniorDashboardWeb(this);
//
//    protected PageSeniorDashboardWeb getPageSeniorDashboard() {
//        return getPageSeniorDashboard;
//    }
//
//    private final PageSchedulerWeb getPageScheduler = new PageSchedulerWeb(this);
//
//    protected PageSchedulerWeb getPageScheduler() {
//        return getPageScheduler;
//    }
//
//    private final PageOnboardingInfoWeb getPageOnboardingInfo = new PageOnboardingInfoWeb(this);
//
//    protected PageOnboardingInfoWeb getPageOnboardingInfo() {
//        return getPageOnboardingInfo;
//    }
//
//    private final PageProviderInfoSubTabWeb getPageProviderInfoSubTab = new PageProviderInfoSubTabWeb(this);
//
//    protected PageProviderInfoSubTabWeb getPageProviderInfoSubTab() {
//        return getPageProviderInfoSubTab;
//    }
//
//    private final PageMedicalInfoSubTabWeb getPageMedicalInfoSubTab = new PageMedicalInfoSubTabWeb(this);
//
//    protected PageMedicalInfoSubTabWeb getPageMedicalInfoSubTab() {
//        return getPageMedicalInfoSubTab;
//    }
//
//    private final PageCareCircleSubTabWeb getPageCareCircleSubTab = new PageCareCircleSubTabWeb(this);
//
//    protected PageCareCircleSubTabWeb getPageCareCircleSubTab() {
//        return getPageCareCircleSubTab;
//    }
//
//    private final PageWellnessSurveyWeb getPageWellnessSurvey = new PageWellnessSurveyWeb(this);
//
//    protected PageWellnessSurveyWeb getPageWellnessSurvey() {
//        return getPageWellnessSurvey;
//    }
//
//    private final PageHolisticAssessmentsWeb getPageHolisticAssessments = new PageHolisticAssessmentsWeb(this);
//
//    protected PageHolisticAssessmentsWeb getPageHolisticAssessments() {
//        return getPageHolisticAssessments;
//    }
//
//    private final PageLawtonBrodyADLWeb getPageLawtonBrodyADL = new PageLawtonBrodyADLWeb(this);
//
//    protected PageLawtonBrodyADLWeb getPageLawtonBrodyADL() {
//        return getPageLawtonBrodyADL;
//    }
//
//    private final PageKatzADLWeb getPageKatzADL = new PageKatzADLWeb(this);
//
//    protected PageKatzADLWeb getPageKatzADL() {
//        return getPageKatzADL;
//    }
//
...
//
//    protected PageCaregiverStrainAssessmentWeb getPageCaregiverStrainAssessment() {
//        return getPageCaregiverStrainAssessment;
//    }

//    private final PageCommonLocatorsWeb getPageCommonLocators = new PageCommonLocatorsWeb(this);

//    protected PageCommonLocatorsWeb getPageCommonLocators() {
//        return getPageCommonLocators;
//    }
    ...
    protected LoginPage getLoginPageAndroid() {
        return pageLoginAndroid;
    }

//    private final WelcomePage pageWelcomeAndroid = new WelcomePage(this);

//    protected WelcomePage getPageWelcomeAndroid() {
//        return pageWelcomeAndroid;
//    }

    private final HomePage pageHomeAndroid = new HomePage(this);

    protected HomePage getPageHomeAndroid() {
        return pageHomeAndroid;
    }
