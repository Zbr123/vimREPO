...
@Wellness_Plan
  Scenario Outline: Create a new Wellness Plan
    ...
    And I click on Add Goal Button
      ...
      | zubair			| Automation83|Test			    		|    Test     | 50         |07/15/2023    |10/15/2023    |Well enough  |https://www.ohio.edu/mechanical-faculty/williams/html/PDF/IntroRob.pdf  |		test 		|
