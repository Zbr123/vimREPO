...
Feature: Provider Info
  ...
  Scenario Outline: First time adding new Doctor, Dentist and Pharmacy in Provider Info
   Given I navigate to vimient login page
    ...
    |		Cameron	  | White         | 			Dr 					| 	Flavius			 |	Domitianus			|	Radiologist			| abc@gmail.com			| 			Dentist 				| 	Titus 					 |	Vespasianus 				|	Orthodontist				| def@gmail.com					|	ABC Health Drugstore	|	308 Negra Arroyo Lane	|	Albuquerque |	https://test.vimient.com/ |		Smoke Test		|
 
  @ProviderInfo
  Scenario Outline: User should be able to see Provider info heading on Provider info Page
   Given I navigate to vimient login page
  	When I enter agent email and agent password
  	Then I should see the login success alert
  	When I click on Home tab
    ...
    And I click on senior <SeniorLast> in the list
    When I click on Onboarding Info dashboard subtab
    Then I should be able to see the Provider Info heading in subtab
    And I close the browser
  ...
  Scenario Outline: User should be able to see Profile Info Heading on Provider info Page
   Given I navigate to vimient login page
    ...
    Then I should see the Profile Info heading on the bottom of Provider info page
    And I close the browser
  ...
  Scenario Outline: User should be able to see Medical Info on Provider info Page
    ...
    When I click on Onboarding Info dashboard subtab
    And I click on Provider Info subtab icon
    Then I should see the Medical Info heading on the bottom of Provider info page
    And I close the browser
  ...
  Scenario Outline: User should be able to see Add Doctor Button on Provider info Page
    ...
    When I click on Onboarding Info dashboard subtab
      And I click on Provider Info subtab icon
    Then I should see Add Doctor Button on the Provider Info Page
    And I close the browser
  ...
  Scenario Outline: User should be able to see Add Dentist Button on Provider info Page
   Given I navigate to vimient login page
    ...
    When I click on Onboarding Info dashboard subtab
      And I click on Provider Info subtab icon
    Then I should see Add Dentist Button on the Provider Info Page
  ...
  Scenario Outline: User should be able to see Add Pharmacy Button on Provider info Page
    ...
    When I click on Onboarding Info dashboard subtab
    And I click on Provider Info subtab icon
    Then I should see Add Pharmacy Button on the Provider Info Page
  ...
  Scenario Outline: User should be able to see Save Button on Provider info Page
   Given I navigate to vimient login page
    ...
    When I click on Onboarding Info dashboard subtab
    And I click on Provider Info subtab icon
    Then I should see Save Button on the Provider Info Page
  ...
  Scenario Outline: User should be able to see Cancel Button on Provider info Page
    ...
    When I click on Onboarding Info dashboard subtab
    And I click on Provider Info subtab icon
    Then I should see Cancel Button on the Provider Info Page
